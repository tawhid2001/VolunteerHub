...
const getWorkName = (workId) =>{
  fetch(`https://volunteer-backend-xi.vercel.app/api/volunteer-work/${workId}/`, {
    headers: {
    ...
    fetch(`https://volunteer-backend-xi.vercel.app/api/volunteer-work/${workId}/`, {
      ...
      .then((work) => {
        ...
        const participantPromises = work.participants.map((participantId) =>
          fetch(`https://volunteer-backend-xi.vercel.app/api/users/${participantId}/`, {
            headers: {
              Authorization: `Token ${token}`,
            },
        ...
        const joinRequestPromise = currentUsername === work.organizer
          ? fetch(`https://volunteer-backend-xi.vercel.app/api/join-requests/`, {
              headers: {
                Authorization: `Token ${token}`,
              },
            }).then((response) => response.json())
...
const approveRequest = (requestId) => {
  ...
  fetch(`https://volunteer-backend-xi.vercel.app/api/join-requests/${requestId}/approve/`, {
    method: "POST",
    headers: {
      Authorization: `Token ${token}`,
    },
...
const rejectRequest = (requestId) => {
  ...
  fetch(`https://volunteer-backend-xi.vercel.app/api/join-requests/${requestId}/reject/`, {
    method: "POST",
    headers: {
      Authorization: `Token ${token}`,
    },
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (token) {
    fetch(`https://volunteer-backend-xi.vercel.app/api/volunteer-work/${workId}/has-reviewed/`, {
      method: 'GET',
      headers: {
        'Authorization': `Token ${token}`,
      },
...
const handleReview = (event) => {
  ...
  fetch(`https://volunteer-backend-xi.vercel.app/api/reviews/`, {
      method: 'POST',
      headers: {
          'Content-Type': 'application/json',
          'Authorization': `Token ${token}`,
...
const fetchReviews = () => {
  ...
  fetch(`https://volunteer-backend-xi.vercel.app/api/reviews/?volunteer_work=${workId}`)
    .then(response => response.json())
    .then(data => {
      console.log(data);
...
const editReview = (reviewId) => {
  ...
  fetch(`https://volunteer-backend-xi.vercel.app/api/reviews/${reviewId}/`, {
    method: 'GET',
    headers: {
      "Content-Type": "application/json",
      "Authorization": `Token ${token}`
